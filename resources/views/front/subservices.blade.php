...
@section('content')
 ...
 <section class="flex items-center gap-2 mt-10 container">
    <a href="{{ route('front.index') }}" class="text-blue-700">Anasayfa</a>
    <span class="text-gray-500">></span>
    <span class="text-gray-500">Hizmetlerimiz</span>
      <span class="text-gray-500">></span>
    <span class="text-gray-500">Hizmetlerimiz</span>
 </section>
    <section class="py-20 courses" id="courses">
        <div class="container">
            <div class="row">
