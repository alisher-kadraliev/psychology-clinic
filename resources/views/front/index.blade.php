...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        ...
                        <div class="main-content">
                            ...
                            <p>Randevu almak için lütfen telefon numaramızı arayın.</p>
                            <div class="main-button">
                                <a href="tel:05521214124">Randevu Al</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        ...
                        <div class="main-content">
                            <h4>Hizmetlerimiz</h4>
                            <p>KUTA, bedensel ve ruhsal sağlığı bir bütün olarak ele alır.</p>
                            <div class="main-button">
            ...
            <div class="row">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body !visible">
                                    KUTA, bedensel ve ruhsal sağlığı bir bütün olarak ele alır. Psikologlar,
                                    fizyoterapistler ve diyetisyenler bir araya gelerek sizin ihtiyaçlarınıza özel bir
                                    yaklaşım sunarlar.
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-5 align-self-center">
                    <div class="section-heading">
                        ...
                        <h2>Neden Kuta?</h2>
                        <div>
                            Neden <strong>KUTA?</strong>
                            KUTA'nın anlamını "Kutsal Yaşam Enerji Gücü" olarak açıklamak müthiş bir katkı olur. Bu anlam,
                            merkezin sunduğu hizmetlerin ruhunu ve amacını çok iyi yansıtıyor. <strong>KUTA</strong>
                            Sağlıklı Yaşam Merkezi,
                            insanların bedenlerini ve ruhlarını kutsal bir yaşam enerjisiyle iyileştirmeye yönelik bir güç
                            merkezi gibi. Bu, sadece fiziksel sağlıkla değil, aynı zamanda içsel huzur ve dengeyle de ilgili
                            bir yaklaşımı vurguluyor. Bu anlamı eklemek, merkezin misyonunu daha derinlemesine anlamamızı
                            sağlar ve insanlara sağlıklı yaşam yolculuklarında ilham verir.<strong>KUTA</strong>'yı tercih
                            etmenin pek çok
                            nedeni var:</div>
                        <div class="main-button">
                            <a href="#">İletişime Geç</a>
    ...
    <section class="pt-32">
        <div class="relative container">
            <div class="flex max-lg:flex-col gap-14 max-lg:gap-10">
                <div class="w-2/3 mx-auto flex max-lg:w-full">
                    <div class="flex flex-col text-center gap-4">
                        <div
                            class="text-[#796ad8] flex justify-center text-6xl max-lg:text-3xl font-extrabold  gap-2 mb-2">
                            Hakkımızda
                        </div>
                        <div class="font-bold text-2xl">Yeni Nesil Sağlık Merkezi</div>
                        <div class="bg-[#f1f0fe] p-5 rounded-lg">
                            Hakkımızda
                            <strong> Yeni Nesil Sağlık Merkezi</strong>

                            KUTA Sağlıklı Yaşam Merkezi, sizin sağlığınızı en üst düzeye çıkarmak için kapsamlı bir hizmet
                            sunar. Psikologlarımız, duygusal denge ve içsel huzurunuz için terapötik destek sağlayarak
                            stresle baş etme, ilişki problemleri, kaygı ve depresyon gibi konularda size rehberlik ederler.
                            Fizyoterapistlerimiz ise hareket kısıtlılıklarınızı, kas-iskelet sistemi sorunlarınızı ve spor
                            yaralanmalarınızı ele alır, özel tedavi ve egzersiz programlarıyla fiziksel iyileşmenize destek
                            olurlar.

                            ​

                            Ayrıca diyetisyenlerimiz, sizin bireysel ihtiyaçlarınıza uygun olarak dengeli beslenme planları
                            hazırlarlar. Beslenme alışkanlıklarınızı değerlendirir, kilo kontrolü, metabolizma hızlandırma
                            ve genel sağlık optimizasyonu konularında size rehberlik ederler. Böylece sağlıklı beslenme ve
                            yaşam tarzı değişiklikleriyle daha enerjik, daha zinde ve daha sağlıklı bir yaşam sürmenizi
                            desteklerler.

                            ​

                            KUTA Sağlıklı Yaşam Merkezi olarak, sizin sağlığınız ve refahınız bizim önceliğimizdir.
                            İhtiyaçlarınıza özel çözümler sunarak sağlıklı bir yaşamın kapılarını sizin için aralamaktan
                            mutluluk duyuyoruz.
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="counter">
                                    ...
                                    <p class="count-text ">Tercümanlar</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="counter">
                                    <h2 class="timer count-title count-number" data-to="50" data-speed="1000"></h2>
                                    <p class="count-text ">Çalışan Öğrenciler</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="counter end">
                                    <h2 class="timer count-title count-number" data-to="15" data-speed="1000"></h2>
                                    <p class="count-text ">Yıllık Tecrübe</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-member">
                            <div class="main-content">
                                ...
                                <span class="category">{{ $team->position }}</span>
                                <h4>{{ $team->title }}</h4>
                                <ul class="social-icons">
                                    <li><a href="{{ $team->facebook }}"><i class="fab fa-facebook"></i></a></li>
                    ...
                    <div class="section-heading">
                        ...
                        <div class="flex flex-col gap-2 mt-3">
                            ...
                            <div class="flex items-center gap-2">
                                <a href="">
                                    <img class="w-8"
                                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/2023_Facebook_icon.svg/1200px-2023_Facebook_icon.svg.png?20231011122028"
                                        alt="">
                                </a>
                                <a href="">
                        ...
                        <div class="special-offer">
                            <span class="offer">Özel Teklif<br><em>50%</em></span>
                            <h6>Geçerlilik Süresi: <em>24 April 2036</em></h6>
                            <h4>Özel Teklif <em>50%</em> </h4>
                            <a href="#"><i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="contact-us-content">
                        <form id="contact-form" action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <fieldset>
                                        <button type="submit" id="form-submit" class="orange-button">Mesaj Gönder
                                        </button>
                                    </fieldset>
                                </div>
                            </div>
    ...
    <div class=" section">
        <div class="container">
            ...
            <div class="grid grid-cols-7 max-lg:grid-cols-2 justify-center items-center gap-10">
                <img class="object-contain"
                    src="https://static.wixstatic.com/media/a3c153_55e9a7e84ab5470e851e20135735b170~mv2.png/v1/fill/w_200,h_200,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/3.png"
                    alt="">
                <img class="object-contain"
                    src="https://static.wixstatic.com/media/a3c153_55e9a7e84ab5470e851e20135735b170~mv2.png/v1/fill/w_200,h_200,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/3.png"
                    alt="">
